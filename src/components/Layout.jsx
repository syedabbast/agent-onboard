      ...
      <nav className="sticky top-0 z-50 bg-white border-b border-[#e2e8f0]">
        <div className="max-w-6xl mx-auto flex items-center justify-between px-6 py-3">
          <div className="flex items-center gap-3">
            ...
            <span className="font-serif font-semibold text-[#0f172a] text-lg tracking-tight cursor-pointer transition-opacity hover:opacity-70" onClick={() => navigate(isLoggedIn ? '/dashboard' : '/')}>Agent OnBoard</span>
          ...
          <div className="flex items-center gap-4">
            ...
            {isLoggedIn ? (
              ...
              <button
                ...
                className="text-sm text-white bg-[#0a1628] hover:bg-[#1e3a5f] rounded-lg px-4 py-1.5 transition-all duration-200"
              >
                Sign In
              </button>
            )}
