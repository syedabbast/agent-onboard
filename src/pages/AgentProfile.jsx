...
export default function AgentProfile() {
  ...
  const isVerified = true // All registered agents are verified
  ...
  return (
    <div className="min-h-screen bg-[#fffef9]">
      ...
      <div className="max-w-2xl mx-auto px-4 py-12">
        ...
        {/* Identity & Capabilities — private, only show verification status */}
        <div className="bg-white rounded-xl border border-[#e2e8f0] p-6 shadow-sm mb-6">
          <div className="flex items-start gap-4">
            <div className="w-10 h-10 rounded-xl bg-[#edf5f0] flex items-center justify-center flex-shrink-0">
              <svg className="w-5 h-5 text-[#2d6b4a]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /><path d="M9 12l2 2 4-4" /></svg>
            </div>
            <div>
              <h3 className="text-base font-semibold text-[#0f172a]">Verified Agent</h3>
              <p className="text-sm text-[#64748b] mt-1">This agent has a verified identity and defined capabilities on Agent OnBoard. Identity details are private to the agent owner.</p>
              <div className="flex gap-3 mt-3">
                ...
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium bg-[#fef3c7] text-[#92400e]">
